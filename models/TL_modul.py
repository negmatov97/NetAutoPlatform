...
class show:
    ...
    def sh_mac_interf():
        ...
        ssh_session.send(f"enable\r")
        ssh_session.send(f"terminal length 0\r")
        ssh_session.send(f"show mac address-table int gig 1/0/{inter_id}\r")
        time.sleep(1)
        output = ssh_session.recv(65535).decode()
        print(output)
        return output
    ...
    def sh_interf_stat():
        ...
        ssh_session.send(f"enable\r")
        ssh_session.send(f"terminal length 0\r")
        ssh_session.send(f"show int status\r")
        time.sleep(1)
        output = ssh_session.recv(65535).decode()
        print(output)
        return output
...
class config:
    ...
    def w_int_acc():
        ...
        ssh_session.send(f"enable\r")
        ssh_session.send(f"configure\r")
        ssh_session.send(f"int gig 1/0/{inter_id}\r")
        ssh_session.send(f"switchport general allowed vlan 1 untagged\r")
        ssh_session.send(f"end\r")
        time.sleep(1)
        output = ssh_session.recv(65535).decode()
        print(output)
    ...
    def w_int_trk():
        ...
        ssh_session.send(f"switchport general allowed vlan 1 tagged\r")
        ssh_session.send(f"end\r")
        time.sleep(1)
        output = ssh_session.recv(65535).decode()
        print(output)
    ...
    def w_int_ac_vl():
        ...
        ssh_session.send(f"configure\r")
        ssh_session.send(f"int eth 1/0/{inter_id}\r")
        ssh_session.send(f"switchport general allowed vlan {vl_id} untagged\r")
        ssh_session.send(f"switchport pvid {vl_id}\r")
        ssh_session.send(f"end\r")
        time.sleep(1)
        output = ssh_session.recv(65535).decode()
        print(output)
    ...
    def w_int_trk_vl():
        ...
        ssh_session.send(f"configure\r")
        ssh_session.send(f"int eth 1/0/{inter_id}\r")
        ssh_session.send(f"switchport general allowed vlan {vl_id} tagged\r")
        ssh_session.send(f"end\r")
        time.sleep(1)
        output = ssh_session.recv(65535).decode()
        print(output)
    ...
    def w_d_int_trk_vl():
        ...
        ssh_session.send(f"configure\r")
        ssh_session.send(f"int eth 1/0/{inter_id}\r")
        ssh_session.send(f"no switchport general allowed vlan {vl_id}\r")
        ssh_session.send(f"end\r")
        time.sleep(1)
        output = ssh_session.recv(65535).decode()
        print(output)
    ...
    def w_d_int_ac_vl():
        ...
        ssh_session.send(f"int eth 1/0/{inter_id}\r")
        ssh_session.send(f"no switchport general allowed vlan {vl_id}\r")
        ssh_session.send(f"no switchport pvid {vl_id}\r")
